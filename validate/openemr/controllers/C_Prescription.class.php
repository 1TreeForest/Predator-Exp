...
class C_Prescription extends Controller
{
    ...
    public function list_action($id, $sort = "")
    {
        if (empty($id)) {
    ...
    public function send_action($id)
    {
        $_POST['process'] = "true";
        if (empty($id)) {
            $this->function_argument_error();
    ...
    public function send_action_process($id)
    {
    ...
    public function _print_prescription($p, &$toFile)
    {
        $pdf = new Cezpdf($GLOBALS['rx_paper_size']);
        $pdf->ezSetMargins($GLOBALS['rx_top_margin'], $GLOBALS['rx_bottom_margin'], $GLOBALS['rx_left_margin'], $GLOBALS['rx_right_margin']);
    ...
    public function _print_prescription_css($p, &$toFile)
    {
    ...
    public function _print_prescription_old($p, &$toFile)
    {
        $pdf = new Cezpdf($GLOBALS['rx_paper_size']);
        $pdf->ezSetMargins($GLOBALS['rx_top_margin'], $GLOBALS['rx_bottom_margin'], $GLOBALS['rx_left_margin'], $GLOBALS['rx_right_margin']);
        $pdf->selectFont('Helvetica');
    ...
    public function _email_prescription($p, $email)
    {
        if (empty($email)) {
    ...
    public function _fax_prescription($p, $faxNum)
    {
        $err = "Sent fax";
        //strip - ,(, ), and ws
