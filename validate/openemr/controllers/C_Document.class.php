...
class C_Document extends Controller
{
    ...
    public function view_action($patient_id = "", $doc_id)
    {
     ...
     * */
    public function retrieve_action($patient_id = "", $document_id, $as_file = true, $original_file = true, $disable_exit = false, $show_original = false, $context = "normal")
    {
        $encrypted = $_POST['encrypted'];
        $passphrase = $_POST['passphrase'];
        $doEncryption = false;
    ...
    public function queue_action($patient_id = "")
    {
    ...
    public function queue_action_process()
    {
        if ($_POST['process'] != "true") {
            return;
        }
    ...
    public function move_action_process($patient_id = "", $document_id)
    {
        if ($_POST['process'] != "true") {
            return;
        }
    ...
    public function validate_action_process($patient_id = "", $document_id)
    {
    ...
    //
    public function update_action_process($patient_id = "", $document_id)
    {
     ...
     *      names with dots.
     */
    public function _rename_file($fname, $self = false)
    {
    ...
    public function tag_action_process($patient_id = "", $document_id)
    {
        if ($_POST['process'] != "true") {
    ...
    public function image_procedure_action($patient_id = "", $document_id)
    {
    ...
    public function clear_procedure_tag_action($patient_id = "", $document_id)
    {
        if (is_numeric($document_id)) {
     ...
     * @return string
     */
    public function _check_relocation($url, $new_pid = null, $new_name = null)
    {
        //strip url of protocol handler
        $url = preg_replace("|^(.*)://|", "", $url);
    ...
    public function clear_encounter_tag_action($patient_id = "", $document_id)
    {
        if (is_numeric($document_id)) {
