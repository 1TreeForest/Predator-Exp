...
class Document extends ORDataObject
{
    ...
    */
     ...
     */
    public function document_factory_url($url)
    {
        $d = new Document();
    ...
    */
    ...
    public function set_thumb_url($url)
    {
        $this->thumb_url = $url;
    }
    ...
    */
    public function get_url_filepath()
    {
    ...
    */
    ...
    public function get_path_depth()
    {
        return $this->path_depth;
    }
    public function set_path_depth($path_depth)
    {
    ...
    */
    ...
    public function set_docdate($docdate)
    {
        $this->docdate = $docdate;
    }
    public function get_docdate()
    {
        return $this->docdate;
    }
    ...
    public function set_encounter_id($encounter_id)
    {
        $this->encounter_id = $encounter_id;
    }
    public function get_encounter_id()
    {
        return $this->encounter_id;
    }
    public function set_encounter_check($encounter_check)
    {
    ...
    public function get_ccr_type($doc_id)
    {
    ...
    public function set_imported($imported)
    {
    ...
    public function update_imported($doc_id)
    {
    ...
    */
    ...
    public function set_storagemethod($str)
    {
        $this->storagemethod = $str;
    }

    public function get_storagemethod()
    {
        return $this->storagemethod;
    }

    public function set_couch_docid($str)
    {
        $this->couch_docid = $str;
    }

    public function get_couch_docid()
    {
        return $this->couch_docid;
    }

    public function set_couch_revid($str)
    {
        $this->couch_revid = $str;
    }

    public function get_couch_revid()
    {
        return $this->couch_revid;
    }

    public function get_couch_url($pid, $encounter)
    {
    ...
    //
    public function change_patient($new_patient_id)
    {
        $couch_docid = $this->get_couch_docid();
     ...
     */
    public function get_thumb_name($file_name)
    {
     ...
     */
    public function postPatientNote($provider, $category_id, $message = '')
    {
