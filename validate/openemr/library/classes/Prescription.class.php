...
class Prescription extends ORDataObject
{
    ...
    */
    ...
    public function get_unit_display($display_form = "")
    {
    ...
    public function get_dosage_display($display_form = "")
    {
    ...
    public function set_refills($refills)
    {
        if (is_numeric($refills)) {
            $this->refills = $refills;
        }
    }
    public function get_refills()
    {
        return $this->refills;
    }
    ...
    public function set_substitute($sub)
    {
        if (is_numeric($sub)) {
            $this->substitute = $sub;
        }
    ...
    public function set_erx_source($erx_source)
    {
    ...
    public function set_per_refill($pr)
    {
        if (is_numeric($pr)) {
            $this->per_refill = $pr;
        }
    }
    public function get_per_refill()
    {
    ...
    public function set_provider_id($id)
    {
        if (is_numeric($id)) {
    ...
    public function set_provider($pobj)
    {
    ...
    public function set_pharmacy_id($id)
    {
        if (is_numeric($id)) {
            $this->pharmacy = new Pharmacy($id);
        }
    }
    public function get_pharmacy_id()
    {
        return $this->pharmacy->id;
    }

    public function set_pharmacist_id($id)
    {
        if (is_numeric($id)) {
    ...
    public function get_start_date_y()
    {
        $ymd = explode("-", $this->start_date);
        return $ymd[0];
    }
    public function set_start_date_y($year)
    {
        if (is_numeric($year)) {
            $ymd = explode("-", $this->start_date);
            $ymd[0] = $year;
    ...
    public function get_start_date_m()
    {
        $ymd = explode("-", $this->start_date);
        return $ymd[1];
    }
    public function set_start_date_m($month)
    {
        if (is_numeric($month)) {
            $ymd = explode("-", $this->start_date);
            $ymd[1] = $month;
    ...
    public function get_start_date_d()
    {
        $ymd = explode("-", $this->start_date);
        return $ymd[2];
    }
    public function set_start_date_d($day)
    {
        if (is_numeric($day)) {
            $ymd = explode("-", $this->start_date);
            $ymd[2] = $day;
    ...
    public function set_encounter($enc)
    {
    ...
    public function set_txDate($txdate)
    {
        return $this->txDate = $txdate;
    }
    public function get_txDate()
    {
        return $this->txDate;
    }
    ...
    public function get_filled_date()
    {
        return $this->filled_date;
    }
    public function set_filled_date($date)
    {
    ...
    public function set_ntx($ntx)
    {
        $this->ntx = $ntx;
    }
    public function get_ntx()
    {
        return $this->ntx;
    }

    public function set_rxnorm_drugcode($rxnorm_drugcode)
    {
        $this->rxnorm_drugcode = $rxnorm_drugcode;
    }
    public function get_rxnorm_drugcode()
    {
        return $this->rxnorm_drugcode;
    }

    public function get_filled_by_id()
    {
        return $this->pharmacist->id;
    }
    public function set_filled_by_id($id)
    {
        if (is_numeric($id)) {
    ...
    public function set_drug_id($drug_id)
    {
        $this->drug_id = $drug_id;
    }
    public function get_drug_id()
    {
        return $this->drug_id;
    }
    ...
    public function get_prescription_display()
    {
    ...
    public function get_prescription_florida_display()
    {
    ...
    public function get_dispensation_count()
    {
        if (empty($this->id)) {
            return 0;
        }
