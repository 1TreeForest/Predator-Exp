...
{
    public const NOT_DONE_PATIENT = 'phys_exm_not_done_patient';
    public const NOT_DONE_MEDICAL = 'phys_exm_not_done_medical';
    public const NOT_DONE_SYSTEM = 'phys_exm_not_done_system';
    public const FINDING_BMI_PERC = 'phys_exm_finding_bmi_perc';
