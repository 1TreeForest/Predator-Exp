...
class InsuranceCompany extends ORDataObject
{
    ...
    */
    public $ins_type_code_array = array('','Other HCFA'
                                        ,'Medicare Part B'
                                        ,'Medicaid'
                                        ,'ChampUSVA'
                                        ,'ChampUS'
    ...
    public $ins_claim_type_array = array(''
                                       ,'16'
                                       ,'MB'
                                       ,'MC'
                                       ,'CH'
    ...
    public function set_x12_receiver_id($id)
    {
    ...
    public function utility_insurance_companies_array()
    {
