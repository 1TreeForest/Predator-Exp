    ...
    public function generate($token, $events)
    {
        ...
        foreach ($events as $event) {
            ...
            if ($event['M_group'] == 'REMINDER') {
                ...
                } elseif ((!empty($event['appts_start'])) && (!empty($event['appts_end']))) {
                ...
                } elseif ($event['E_instructions'] == 'yearly') {
                ...
                if ($event['E_timing'] == '5') {
                    ...
                    } elseif (($event['E_timing'] == '3') || ($event['E_timing'] == '4')) {
...
class Callback extends Base
{
    public function receive($data = '')
    {
        ...
        if (!$data['patient_id']) {  //process AVM responses??
            ...
            } elseif ($data['pc_eid']) {  //process responses from callback into MedEx.php - no pid just pc_eid
