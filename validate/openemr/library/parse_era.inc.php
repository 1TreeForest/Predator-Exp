...
function parse_era($filename, $cb)
{
    ...
    while (true) {
        ...
        elseif ($segid == 'DTM' && $out['loopid'] == '2100') {
            // ignore?
        ...
        elseif ($segid == 'AMT' && $out['loopid'] == '2100') {
        ...
        // part of claim balancing.
        elseif ($segid == 'QTY' && $out['loopid'] == '2100') {
