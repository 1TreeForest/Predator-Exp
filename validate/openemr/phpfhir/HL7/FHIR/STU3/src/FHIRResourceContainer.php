...
class FHIRResourceContainer implements \JsonSerializable
{
    ...
    public function xmlSerialize($returnSXE = false, $sxe = null)
    {
        ...
        } elseif (isset($this->DeviceComponent)) {
        ...
        } elseif (isset($this->EligibilityRequest)) {
            $this->EligibilityRequest->xmlSerialize(true, $sxe->addChild('EligibilityRequest'));
        } elseif (isset($this->EligibilityResponse)) {
        ...
        } elseif (isset($this->ExpansionProfile)) {
        ...
        } elseif (isset($this->ImagingManifest)) {
        ...
        } elseif (isset($this->ReferralRequest)) {
        ...
        } elseif (isset($this->ServiceDefinition)) {
