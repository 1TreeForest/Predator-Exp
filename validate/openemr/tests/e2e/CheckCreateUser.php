...
{
    public const BROWSER = "chrome";
    public const BROWSER_URL = "http://localhost/openemr";
    public const URL = "http://localhost/openemr/interface/login/login.php?site=default";
    public const VAR_AUTHUSER = "admin";
    public const VAR_PASS = "pass";
