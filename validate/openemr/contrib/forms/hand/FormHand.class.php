...
class FormHand extends ORDataObject
{
    ...
    public function set_right_3($tf)
    {
        $this->right_3 = $tf;
    }
    ...
    public function set_handedness($data)
    {
        if (!empty($data)) {
            $this->handedness = $data;
        }
    }
    public function get_handedness_l()
    {
        return $this->handedness == "Left" ? "CHECKED" : "";
    }
    public function get_handedness_r()
    {
        return $this->handedness == "Right" ? "CHECKED" : "";
    }
    public function get_handedness_b()
    {
