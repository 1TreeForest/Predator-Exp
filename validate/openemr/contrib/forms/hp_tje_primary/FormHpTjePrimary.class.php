...
class FormHpTjePrimary extends ORDataObject
{
    ...
    public function get_date_of_onset_y()
    {
        $ymd = explode("-", $this->date_of_onset);
        return $ymd[0];
    }

    public function set_date_of_onset_y($year)
    {
        if (is_numeric($year)) {
            $ymd = explode("-", $this->date_of_onset);
            $ymd[0] = $year;
    ...
    public function get_date_of_onset_m()
    {
        $ymd = explode("-", $this->date_of_onset);
        return $ymd[1];
    }

    public function set_date_of_onset_m($month)
    {
        if (is_numeric($month)) {
            $ymd = explode("-", $this->date_of_onset);
            $ymd[1] = $month;
    ...
    public function get_date_of_onset_d()
    {
        $ymd = explode("-", $this->date_of_onset);
        return $ymd[2];
    }

    public function set_date_of_onset_d($day)
    {
        if (is_numeric($day)) {
            $ymd = explode("-", $this->date_of_onset);
            $ymd[2] = $day;
    ...
    public function set_referred_by($string)
    {
    ...
    public function set_complaints($string)
    {
    ...
    public function set_prior_symptoms($string)
    {
    ...
    public function set_aggravated_symptoms($string)
    {
    ...
    public function set_event_description($description)
    {
    ...
    public function set_teeth_sore_number($num)
    {
    ...
    public function set_teeth_mobile_number($num)
    {
    ...
    public function set_teeth_fractured_number($num)
    {
    ...
    public function set_teeth_avulsed_number($num)
    {
    ...
    public function set_precipitating_factors_other_text($string)
    {
    ...
    public function set_history($array)
    {
        $this->history = $array;
    }
    ...
    public function set_previous_accidents($array)
    {
    ...
    public function _name_rows($name, $row_array)
    {
        $a = array();
