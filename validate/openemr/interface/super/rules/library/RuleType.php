...
class RuleType
{
    ...
    public const ActiveAlert = "activealert";
    public const PassiveAlert = "passivealert";
    public const CQM = "cqm";
    public const AMC = "amc";
    public const PatientReminder = "patientreminder";

    public function __construct($code, $lbl)
    {
        $this->lbl = $lbl;
        $this->code = $code;
    }
