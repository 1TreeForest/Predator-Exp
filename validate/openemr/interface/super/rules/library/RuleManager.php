...
class RuleManager
{
    ...
    public const SQL_RULE_REMINDER_INTERVAL =
    "SELECT id,
            method,
            method_detail,
            value
     ...
     */
    public function getRuleTargetActionGroups($rule)
    {
    ...
    public function updateSummary($ruleId, $types, $title, $developer, $funding, $release, $web_ref)
    {
