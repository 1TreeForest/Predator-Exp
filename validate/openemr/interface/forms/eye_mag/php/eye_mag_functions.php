                    ...
                    foreach ($options as $option) {
                        ...
                        if ($option == "DM") {
                            ...
                            if ((stripos($FIELDS[$location1], $NVD) !== false) ||
                                ...
                                $hit_PDR[$side] = '1';
                            } elseif ((stripos($FIELDS[$location2], $PPDR) !== false) ||
                                ...
                                $hit_PPDR[$side] = '1';
                            } elseif ((stripos($FIELDS[$location], $BDR) !== false) ||
...
function display_GlaucomaFlowSheet($pid, $bywhat = 'byday')
{
    ...
    if ($priors) {
        foreach ($priors as $visit) {
            ...
            } elseif (!$ODIOPTARGETS[$j]) {  //get this from the provider's default list_option
    ...
    if ($count_Meds > '0') {
        foreach ($PMSFH[0]['Medication'] as $drug) {
            ...
            } elseif (($drug['row_subtype'] == "eye") && ($drug['enddate'] > "") && (strtotime($drug['enddate']) < strtotime($visit_date))) {//what meds have a subtype eye that are discontinued?
