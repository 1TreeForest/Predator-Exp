...
class pnHTML
{
     ...
     */
    public function Pager($startnum, $total, $urltemplate, $perpage = 10)
    {
     ...
     */
    public function Redirect($url, $waittime = 3)
    {
     ...
     * @access public
     */
    public function ConfirmAction($confirm_text, $confirm_url, $cancel_text, $cancel_url, $arg = array())
    {
        $compoutput = new pnHTML();
     ...
     * otherwise null
     */
    public function TableStart($title = '', $headers = array(), $border = 0, $width = '100%', $cellpadding = 0, $cellspacing = 0)
    {
     ...
     * otherwise null
     */
    public function TableRowStart($align = 'center', $valign = 'middle')
    {
     ...
     * otherwise null
     */
    public function TableColStart($colspan = 1, $align = 'center', $valign = 'middle', $rowspan = 1)
    {
     ...
     * otherwise null
     */
    public function TableAddRow($row, $align = 'center', $valign = 'middle')
    {
        if (empty($row)) {
            return;
        }
     ...
     * otherwise null
     */
    public function FormSubmit($label = 'Submit', $accesskey = '')
    {
        $this->tabindex++;
        $output = '<input'
            .' type="submit"'
     ...
     * otherwise null
     */
    public function FormText($fieldname, $contents = '', $size = 16, $maxlength = 64, $password = false, $accesskey = '')
    {
        if (empty($fieldname)) {
            return;
        }
     ...
     * otherwise null
     */
    public function FormTextArea($fieldname, $contents = '', $rows = 6, $cols = 40, $wrap = 'soft', $accesskey = '')
    {
        if (empty($fieldname)) {
            return;
        }
     ...
     * otherwise null
     */
    public function FormHidden($fieldname, $value = '')
    {
        if (empty($fieldname)) {
            return;
        }
     ...
     * otherwise null
     */
    public function FormSelectMultiple($fieldname, $data, $multiple = 0, $size = 1, $selected = '', $accesskey = '', $disable = false, $readonly = false)
    {
        if (empty($fieldname)) {
            return;
        }
     ...
     * otherwise null
     */
    public function FormCheckbox($fieldname, $checked = false, $value = '1', $type = 'checkbox', $accesskey = '')
    {
        if (empty($fieldname)) {
            return;
        }
     ...
     * otherwise null
     */
    public function FormFile($fieldname, $size = 32, $maxsize = 1000000, $accesskey = '')
    {
        if (empty($fieldname)) {
            return;
        }
