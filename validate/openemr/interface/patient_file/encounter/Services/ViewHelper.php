...
class ViewHelper
{
     ...
     * @return array|bool
     */
    public static function getRegistry($state = "1", $limit = "unlimited", $offset = "0")
    {
     ...
     * @return string
     */
    public static function createEncounterMenu(array $elements)
    {
     ...
     * @return array|bool
     */
    public static function getLayoutBasedForms()
    {
     ...
     * @return array
     */
    public static function parseRegistry(array $registry, $oldCategory = '')
    {
        $prevCategory = 'null';
        $return = array();
     ...
     * @return array|bool
     */
    public static function getModuleMenuItems()
    {
