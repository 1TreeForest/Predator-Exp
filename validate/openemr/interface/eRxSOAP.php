...
class eRxSOAP
{
    public const ACTION_ALLERGIES      = 'allergies';
    public const ACTION_MEDICATIONS    = 'medications';

    public const FLAG_PRESCRIPTION_PRESS   = '1';
    public const FLAG_PRESCRIPTION_IMPORT  = '2';
    public const FLAG_ALLERGY_PRESS        = '3';
    public const FLAG_ALLERGY_IMPORT       = '4';
