...
class acl_setup
{
    ...
    public $aco_section = array();
    public $aco = array();

    public $aro_section = array();
    public $aro = array();
    public $aro_group = array();

    public $axo_section = array();
    public $axo = array();
    public $axo_group = array();

    public $acl = array();

    public function acl_setup()
    {
...
class acl_test extends gacl_test_case
{
    ...
    public function acl_test($name)
    {
        $this->gacl_test_case($name);
        $this->acl_setup = &$GLOBALS['acl_setup'];
    }

    public function test_check_luke_lounge()
    {
    ...
    public function test_check_luke_engines()
    {
    ...
    public function test_check_chewie_guns()
    {
    ...
    public function test_check_chewie_engines()
    {
    ...
    public function test_query_luke_lounge()
    {
