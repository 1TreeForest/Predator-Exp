...
class gacl_api extends gacl
{
     ...
     */
    public function consolidated_edit_acl($aco_section_value, $aco_value, $aro_section_value, $aro_value, $return_value)
    {
        ...
        if (is_array($acl_ids) and $acl_ids_count == 1) {
            ...
            if (!$this->add_acl(
                array( $aco_section_value => array($aco_value) ),
     ...
     *
     */
    public function is_conflicting_acl($aco_array, $aro_array, $aro_group_ids = null, $axo_array = null, $axo_group_ids = null, $ignore_acl_ids = null)
    {
     ...
     * @param string ACL Section Value
     */
    public function edit_acl($acl_id, $aco_array, $aro_array, $aro_group_ids = null, $axo_array = null, $axo_group_ids = null, $allow = 1, $enabled = 1, $return_value = null, $note = null, $section_value = null)
    {
     ...
     * @param string Group Type, either 'ARO' or 'AXO'
     */
    public function add_group_object($group_id, $object_section_value, $object_value, $group_type = 'ARO')
    {
     ...
     * @param string Group Type, either 'ARO' or 'AXO'
     */
    public function del_group_object($group_id, $object_section_value, $object_value, $group_type = 'ARO')
    {
     ...
     * @param string Group Type, either 'ARO' or 'AXO'
     */
    public function edit_group($group_id, $value = null, $name = null, $parent_id = null, $group_type = 'ARO')
    {
     ...
     */
    public function rebuild_tree($group_type = 'ARO', $group_id = null, $left = 1)
    {
     ...
     * @param string Group Type, either 'ARO' or 'AXO'
     */
    public function del_group($group_id, $reparent_children = true, $group_type = 'ARO')
    {
     ...
     * @param string Object Type, either 'ACO', 'ARO', or 'AXO'
     */
    public function edit_object($object_id, $section_value, $name, $value = 0, $order = 0, $hidden = 0, $object_type = null)
    {
     ...
     */
    public function del_object($object_id, $object_type = null, $erase = false)
    {
     ...
     * @param string Object Type, either 'ACO', 'ARO', 'AXO', or 'ACL'
     */
    public function edit_object_section($object_section_id, $name, $value = 0, $order = 0, $hidden = 0, $object_type = null)
    {
     ...
     */
    public function del_object_section($object_section_id, $object_type = null, $erase = false)
    {
