                        ...
                        <div class="row">
                            ...
                            <div class="row">
                                <div class="col-sm-12 form-group">
                                    ...
                                    <div class="controls inline-inputs">
                                        <input class="form-control" style="width: 100%" name="passaddon" id="passaddon" placeholder="<?php echo xla('on file email'); ?>" type="email" autocomplete="on" value="e@mail.com" />
                                    </div>
                                </div>
                            </div>
