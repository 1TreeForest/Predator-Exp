...
class DBTable
{
    ...
    public $Sets;
    public $IsView = false;
    public static $NUMERIC_TABLE_PREFIX = 'TBL_';
    public static $NUMERIC_COLUMN_PREFIX = 'COL_';
     ...
     * @return number
     */
    public function NumberOfPrimaryKeyColumns()
    {
     ...
     * @return string
     */
    public function GetPrimaryKeyName($remove_prefix = true)
    {
     ...
     * @return string
     */
    public function GetColumnNameByIndex($index, $remove_prefix = true)
    {
        $count = 0;
     ...
     * @return bool
     */
    public function PrimaryKeyIsAutoIncrement()
    {
     ...
     * @return string
     */
    public function GetDescriptorName($remove_prefix = true)
    {
        foreach ($this->Columns as $column) {
