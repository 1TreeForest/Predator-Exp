...
class DataAdapter implements IObservable
{
     ...
     */
    public function __construct($csetting, $listener = null, IDataDriver $driver = null, $label = null)
    {
        $this->_driver = $driver;
        if ($this->_driver) {
