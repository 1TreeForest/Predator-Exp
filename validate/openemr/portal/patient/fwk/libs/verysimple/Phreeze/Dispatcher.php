...
class Dispatcher
{
     ...
     */
    public static $IGNORE_DEPRECATED = true;
     ...
     */
    public static $FAST_LOOKUP = false;
     ...
     */
    public static function Dispatch($phreezer, $renderEngine, $action = '', $context = null, $router = null)
    {
        if ($router == null) {
