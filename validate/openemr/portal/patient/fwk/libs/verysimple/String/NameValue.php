...
class NameValue
{
     ...
     *          "=")
     */
    public function __construct($line = "", $delim = "=", $nameonly = false)
    {
     ...
     */
    public static function Parse($lines, $delim = "=", $nameonly = false)
    {
        $return = array();
     ...
     * @return array
     */
    public static function ToSimpleArray($nvArray)
    {
        $sa = array();
