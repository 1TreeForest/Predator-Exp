...
class SimpleTemplate
{
    ...
    public static $_MERGE_TEMPLATE_VALUES = null;
     ...
     */
    public static function Merge($template, $values, $stripMissingValues = true, $ldelim = "{{", $rdelim = "}}")
    {
     ...
     * @return string merged template
     */
    public static function MergeSimple($template, $values, $ldelim = "{{", $rdelim = "}}")
    {
        $replacements = array();
     ...
     * @return string merged template
     */
    public static function MergeRegEx($template, $values, $ldelim = "{{", $rdelim = "}}")
    {
     ...
     * @param array $matches
     */
    public static function _MergeRegExCallback($matches)
    {
