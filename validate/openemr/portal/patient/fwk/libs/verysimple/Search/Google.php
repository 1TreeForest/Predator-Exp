...
class Google extends SearchEngine
{
     ...
     * @return SearchResult
     */
    public function GetLinks($url, $max = 10)
    {
     ...
     * @return SearchRank
     */
    public function GetRank($url, $query, $maxresults = 30)
    {
        $current_page = 0;
        $result_counter = 0;
        $page_size = 10;
     ...
     * @return SearchRank
     */
    public function GetPositionOnPage($url, &$result)
    {
        $rank = new SearchRank();
        $counter = 0;
     ...
     * @throws Exception
     */
    public function DoSearch($query, $start = 0, $max = 10, $filter = false, $restrict = "", $safe = false, $lr = "", $ie = "", $oe = "")
    {
        $result = null;
        $continue = true;
        $counter = 0;
