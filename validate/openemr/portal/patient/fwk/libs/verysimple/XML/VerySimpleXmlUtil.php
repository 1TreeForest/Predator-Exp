...
class VerySimpleXmlUtil
{
    ...
    public static $reservedAttrib = array(
            "&",
            "\"",
            "'",
            "<",
    ...
    public static $replacementsAttrib = array(
            "&amp;",
            "&quot;",
            "&apos;",
            "&lt;",
    ...
    public static $replacementsTempAttrib = array(
            "~amp;",
            "~quot;",
            "~apos;",
            "~lt;",
    ...
    public static $reservedText = array(
            "&",
            "<",
            ">"
    );
    public static $replacementsText = array(
            "&amp;",
            "&lt;",
            "&gt;"
    );
    public static $replacementsTempText = array(
            "~amp;",
            "~lt;",
            "~gt;"
    );
     ...
     */
    public static function SafeParse($xml, $emptyVal = null, $reAttempt = true)
    {
        if (!$xml) {
            $xml = $emptyVal;
            if (!$xml) {
     ...
     */
    public static function Escape($str, $escapeQuotes = false)
    {
        if ($escapeQuotes) {
     ...
     * @return array
     */
    public static function ToArray($xmlstring, $recurse = false, $emptyVal = null)
    {
     ...
     *
     */
    public static function RecurseXmlObjToArr($obj, &$arr)
    {
     ...
     * @return string XML
     */
    public static function ToXML($var, $root = "")
    {
        $xml = "";
     ...
     * @return string
     */
    public static function GetInnerText(XMLReader $xml, $default = "")
    {
     ...
     * @return object
     */
    public static function ConvertReader(XMLReader $xml)
    {
        $node_types = array(
                0 => "XMLReader::NONE",
                1 => "XMLReader::ELEMENT",
