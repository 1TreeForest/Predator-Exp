...
class HttpRequest
{
    ...
    public static $USER_AGENT = "verysimple::HttpRequest";
    public static $VERIFY_CERT = false;
     ...
     *          $params
     */
    public static function RestRequest($endpoint, $method, $params = array())
    {
     ...
     * @return string
     */
    public static function Post($url, $data, $verify_cert = false, $timeout = 30)
    {
     ...
     * @return string
     */
    public static function Get($url, $data = "", $verify_cert = false, $timeout = 30)
    {
        if (function_exists("curl_init")) {
            return HttpRequest::CurlPost($url, $data, $verify_cert, $timeout);
        } else {
     ...
     * @return string
     */
    public static function Put($url, $data = "", $verify_cert = false, $timeout = 30)
    {
        if (function_exists("curl_init")) {
     ...
     * @return string
     */
    public static function FileGet($url, $data = "", $verify_cert = false, $timeout = 30)
    {
     ...
     * @return string
     */
    public static function FilePost($url, $data = "", $verify_cert = false, $timeout = 30)
    {
        $qs = HttpRequest::ArrayToQueryString($data);
        $url = $url . ($qs ? "?" . $qs : "");
     ...
     * @return string
     */
    public static function CurlGet($url, $data = "", $verify_cert = false, $timeout = 30)
    {
     ...
     * @return string
     */
    public static function CurlPost($url, $data, $verify_cert = false, $timeout = 30)
    {
     ...
     * @return string
     */
    public static function CurlPut($url, $data, $verify_cert = false, $timeout = 30)
    {
     ...
     * @return string
     */
    public static function CurlRequest($method, $url, $data, $verify_cert = false, $timeout = 30)
    {
