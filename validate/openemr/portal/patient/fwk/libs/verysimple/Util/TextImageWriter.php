...
class TextImageWriter
{
     ...
     */
    public static function Write($message, $width = 250, $height = 150, $backgroundColor = null, $fontColor = null, $fontId = 1)
    {
     ...
     */
    public static function GetErrorImage($message, $width = 250, $height = 150, $backgroundColor = null, $fontColor = null, $fontId = 1)
    {
        if ($backgroundColor == null) {
            $backgroundColor = array(
                    255,
