...
{
    public static $AN_RESPONSE_UNKNOWN = 0;
    public static $AN_RESPONSE_SUCCESS = 1;
    public static $AN_RESPONSE_DECLINED = 2;
    public static $AN_RESPONSE_ERROR = 3;
    public static $AN_RESPONSE_HOLD_FOR_REVIEW = 4;
    private $test_mode = false;
    private $post_url = "https://secure.authorize.net/gateway/transact.dll";
    private $api_version = "3.1";
    private $delim_data = "True";
    public function Init($testmode)
    {
        // set the post url depending on whether we're in test mode or not
        $this->test_mode = $testmode ? "true" : "false";
    }
    public function Process(PaymentRequest $req)
    {
