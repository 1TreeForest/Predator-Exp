...
abstract class PaymentProcessor
{
     ...
     *          default = false
     */
    final public function __construct($testmode = false, $username = "", $password = "", $signature = "")
    {
     ...
     * @param bool $testmode
     */
    abstract public function Init($testmode);
     ...
     */
    abstract public function Process(PaymentRequest $req);
     ...
     * @return PaymentResponse
     */
    abstract public function Refund(RefundRequest $req);
