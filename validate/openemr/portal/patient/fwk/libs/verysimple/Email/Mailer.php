...
class Mailer
{
     ...
     */
    public function __construct($method = MAILER_METHOD_SENDMAIL, $path = "/usr/sbin/sendmail")
    {
        $pair = explode("@", $path);
     ...
     * @param string $body
     */
    public function QuickSend($to, $from, $subject, $body, $format = MESSAGE_FORMAT_TEXT)
    {
