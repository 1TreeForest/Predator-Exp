...
class Pop3Client
{
     ...
     *
     */
    public function Open($user, $pass, $host, $port = "110", $mbtype = "pop3", $mbfolder = "INBOX", $options = null, $retries = 1)
    {
     ...
     *
     */
    public function Close($empty_trash = true)
    {
     ...
     * @return Array
     */
    public function GetQuickHeaders()
    {
     ...
     */
    public function GetHeader($msgno)
    {
     ...
     *
     */
    public function GetAttachments($msgno, $include_raw_data = true)
    {
     ...
     *
     */
    public function GetAttachmentRawData($msgno, $partnum, $encoding_id = 0)
    {
     ...
     *
     */
    public function GetPrimaryType(&$structure)
    {
     ...
     *
     */
    public function GetMessageBody($msgnum, $prefer_html = true)
    {
        if ($prefer_html) {
     ...
     *
     */
    public function GetPart($msg_number, $mime_type, $structure = false, $part_number = false)
    {
        $stream = $this->mbox;
        $prefix = "";
