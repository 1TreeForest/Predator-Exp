...
class Brand extends NotORM
{
    ...
    public function getBrandDetailAction($page, $id, $user_id)
    {
        ...
        $sql = "SELECT goods_id,goods_name AS name,shop_price AS retail_price,original_img , goods_thumb AS list_pic_url FROM ecs_goods WHERE brand_id = {$id} LIMIT {$offset},{$page_size}";
