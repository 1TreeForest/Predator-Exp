...
class User extends Api
{
    ...
    public function getRules()
    {
        return array(
            ...
            "withdrawalApi" => array(
                ...
                "bank_addr" => array('name' => "bank_addr", "require" => false, 'min' => 1, 'max' => 20, "desc" => "开户行地址"),
    ...
    public function memberInfoApi()
    {
        ...
        return array('res' => true, 'info' => $data, "allOrderNum" => $order_num, "rank_name" => $rank_name, "logo_other" => $logo_oter, 'kefu_tel' => $kefu_tel, 'kefu_qq' => $kefu_qq);
    }
