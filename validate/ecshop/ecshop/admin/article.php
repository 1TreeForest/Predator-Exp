...
if ($_REQUEST['act'] =='update')
{
    ...
    if ($recommend_url == '')
    {
        $recommend_url = $_POST['article_pic'];
    }
    ...
    if ($exc->edit("title='$_POST[title]', cat_id='$_POST[article_cat]', article_type='$_POST[article_type]', is_open='$_POST[is_open]', author='$_POST[author]', author_email='$_POST[author_email]', keywords ='$_POST[keywords]', file_url ='$file_url',article_pic='$recommend_url', open_type='$open_type',is_recommend='$_POST[is_recommend]', content='$_POST[FCKeditor1]', link='$_POST[link_url]', description = '$_POST[description]', is_index = '$_POST[is_index]'", $_POST['id']))
    {
