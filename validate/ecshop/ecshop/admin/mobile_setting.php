...
elseif ($_REQUEST['act'] == 'end_tiem_edit'){
    ...
    $sql = "update ecs_app_config set val  ='".$_POST['prompt']."' where k ='prompt'";
    $GLOBALS['db']->query($sql);
    $sql = "update ecs_app_config set val  ='".$_POST['yes_no']."' where k ='yes_no'";
    $GLOBALS['db']->query($sql);
...
elseif ($_REQUEST['act'] =='img_edit'){
    ...
    $version = $_POST['version_name'];
    $sql = "update ecs_app_config set val  ='".$version."' where k ='version'";
    $GLOBALS['db']->query($sql);
    $sql = "update ecs_app_config set val  ='".$_POST['day']."' where k ='day'";
    $GLOBALS['db']->query($sql);
    $sql = "update ecs_app_config set val  ='".$_POST['tel']."' where k ='tel'";
    $GLOBALS['db']->query($sql);
...
elseif ($_REQUEST['act'] =='up_default_image'){
    ...
    if(!empty($_POST['default_image_url'])){
        $sql = "update ecs_app_config set val='".$_POST['default_image_url']."' where k='default_image'";
        $GLOBALS['db']->query($sql);
    }
...
elseif ($_REQUEST['act'] =='up_kefu'){
    ...
    $sql = "update  ecs_app_config set val ='".$_POST['kefu_tel']."' where k = 'kefu_tel'";
...
elseif ($_REQUEST['act'] =='up_download'){
    ...
    $sql = "update  ecs_app_config set val ='".$_POST['download']."' where k = 'appdownload'";
    $GLOBALS['db']->getAll($sql);
...
elseif ($_REQUEST['act'] =='up_prompt_image'){
    ...
    if(!empty($_POST['prompt_external_image'])){
        $sql = "update ecs_app_config set val='".$_POST['prompt_external_image']."' where k='prompt_image'";
        $GLOBALS['db']->query($sql);
    }
    $sql = "update ecs_app_config set val  ='".$_POST['prompt_image_url']."' where k ='prompt_image_url'";
    $GLOBALS['db']->query($sql);
    $sql = "update ecs_app_config set val  ='".$_POST['prompt_image_status']."' where k ='prompt_image_status'";
    $GLOBALS['db']->query($sql);
    $sql = "update ecs_app_config set val  ='".$_POST['prompt_bonus_id']."' where k ='prompt_bonus_id'";
    $GLOBALS['db']->query($sql);
...
elseif ($_REQUEST['act'] == 'updata_logistics'){
    ...
    $logistics_userId = $_POST['logistics_userId'];  //赋值
    $logistics_key = $_POST['logistics_key'];
...
elseif ($_REQUEST['act'] == 'save_index_imgae' ||$_REQUEST['act']=='update_index_imgae'){
    ...
    if($_REQUEST['act'] == 'update_index_imgae'){
        $sql = "update ecs_index_prompt  set   image_url='".$src."',image_prompt='".$_POST['img_text']."',sort='".$_POST['sort']."',status='".$_POST['status']."' where id = '".$_POST['id']."'";
    }else{
        $sql = "insert into ecs_index_prompt (image_url,image_prompt,sort,status,ctime) values  ('".$src."','".$_POST['img_text']."','".$_POST['sort']."','".$_POST['status']."','".time()."');";
    }
...
elseif ($_REQUEST['act'] == 'pay_input_one'){
    //微信小程序支付配置
    $pay_small_id = $_POST['pay_small_id'];  //赋值
    $pay_small_sw = $_POST['pay_small_sw'];
    $pay_small_key = $_POST['pay_small_key'];
    $pay_small_secret = $_POST['pay_small_secret'];
    $pay_small_home = $_POST['pay_small_home'];
    $pay_small_gethome = $_POST['pay_small_gethome'];
    $pay_small_is_use = $_POST['is_use_small'];
...
elseif ($_REQUEST['act'] == 'pay_input_two'){
    //微信H5支付配置
    $pay_hfive_id = $_POST['pay_hfive_id'];
    $pay_hfive_page = $_POST['pay_hfive_page'];
    $pay_hfive_sw = $_POST['pay_hfive_sw'];
    $pay_hfive_key = $_POST['pay_hfive_key'];
    $pay_hfive_secret = $_POST['pay_hfive_secret'];
    $pay_hfive_home = $_POST['pay_hfive_home'];
    $pay_hfive_gethome = $_POST['pay_hfive_gethome'];
    $pay_hfive_is_use = $_POST['is_use_hfive'];
...
elseif ($_REQUEST['act'] == 'pay_input_three'){
    ...
    $pay_app_sw = $_POST['pay_app_sw'];
    $pay_app_key = $_POST['pay_app_key'];
    $pay_app_secret = $_POST['pay_app_secret'];
    $pay_app_home = $_POST['pay_app_home'];
    $pay_app_gethome = $_POST['pay_app_gethome'];
    $pay_app_is_use = $_POST['is_use_app'];
...
elseif ($_REQUEST['act'] == 'pay_input_four'){
    //支付宝支付配置
    $pay_zhifu_id = $_POST['pay_zhifu_id'];
    $pay_zhifu_wg = $_POST['pay_zhifu_wg'];
    $pay_zhifu_appid = $_POST['pay_zhifu_appid'];
    $pay_zhifu_sy = $_POST['pay_zhifu_sy'];
    $pay_zhifu_gy = $_POST['pay_zhifu_gy'];
    $pay_zhifu_home = $_POST['pay_zhifu_home'];
    $pay_zhifu_gethome = $_POST['pay_zhifu_gethome'];
    $alipay_h5_url = $_POST['alipay_h5_url'];
    $pay_zhifu_is_use = $_POST['is_use_zhifu'];
...
elseif ($_REQUEST['act'] == 'app_modify'){
    //微信小程序支付配置
    $app_name = $_POST['app_name'];  //赋值
    $app_nowId = $_POST['app_nowId'];
    $app_updateId = $_POST['app_updateId'];
    $app_iosLink = $_POST['app_iosLink'];
    $app_androidLink = $_POST['app_androidLink'];
...
elseif ($_REQUEST['act'] == 'copyright_update'){
    //微信小程序支付配置
    $copyright_one = $_POST['copyright_one'];  //赋值
    $copyright_two = $_POST['copyright_two'];
