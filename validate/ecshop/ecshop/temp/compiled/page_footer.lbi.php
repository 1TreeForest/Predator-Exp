<div class="footads"><IMG alt="广告说明" src="<?php echo $this->_var['template_dir']; ?>/images/footad.jpg"></div>

<div class="footer">
<div class="footHelp">
  <table  border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td><?php if ($this->_var['navigator_list']['bottom']): ?>
...
?>
  ...
  <?php echo $this->_var['lang']['icp_number']; ?>:<a href="http://beian.miit.gov.cn/" target="_blank"><?php echo $this->_var['icp_number']; ?></a><br />
  <?php endif; ?>
  <?php 
$k = array (
  'name' => 'query_info',
